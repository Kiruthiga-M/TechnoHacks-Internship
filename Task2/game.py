...
game_title.place(x=330, y=0)


label = Label(top_frame, text=player + " Turn", font=('arial',30), bg = "skyblue", fg ="white")
label.place(x=440,y= 200)

reset_button = Button(top_frame, text="Restart Game", font=('arial',30),bg = "skyblue", fg ="white", command=new_game)
